...
def api_papers():
    ...
    primary_topic_filter = request.args.get("primary_topic", "", type=str)
    ...
    # Filter by primary_topic if specified
    if primary_topic_filter:
        all_papers = [
            p for p in all_papers if p.get("primary_topic") == primary_topic_filter
        ]
